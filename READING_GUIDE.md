...
| 主题 | 相关文档 |
|------|---------|
| **SeaBIOS** | [SEABIOS_LOAD_BOOT_SECTOR.md](SEABIOS_LOAD_BOOT_SECTOR.md), [SEABIOS_E820_CONSTRUCTION.md](SEABIOS_E820_CONSTRUCTION.md), [SEABIOS_GRUB_ABI_COMPLIANCE_ANALYSIS.md](SEABIOS_GRUB_ABI_COMPLIANCE_ANALYSIS.md) ⭐ 新增 |
