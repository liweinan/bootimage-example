...
#### 2.1 为什么BIOS映射到实模式内存空间只有128KB，其他的部分如何访问执行？
...
#### 2.3 问题 2：为什么 BIOS 存储在 4GB 地址空间顶部？
...
#### 2.4 问题 2.1：在更大内存的主机上，4GB 地址空间计算还适用吗？
...
#### 2.5 问题 2.2：QEMU 和 SeaBIOS 如何支持更大内存的虚拟机？
...
#### 2.6 问题 2.3：64 位虚拟机如何支持 32 位内存地址？
...
#### 2.7 问题 2.4：实际硬件（64位CPU）如何支持32位内存地址？
...
#### 2.8 问题 3：地址 `0x100000000ULL - bios_size` 是实模式吗？
