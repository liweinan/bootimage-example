...
3. [引导扇区程序：从 SeaBIOS 到用户代码的执行](#3-引导扇区程序从-seabios-到用户代码的执行)
4. [boot.asm 与 GRUB boot.S 的相似之处](#4-bootasm-与-grub-boots-的相似之处)
5. [Linux 内核接管 BIOS](#5-linux-内核接管-bios)
6. [总结：完整流程时间线](#总结完整流程时间线)
7. [关键源代码文件索引](#关键源代码文件索引)
8. [参考资料](#参考资料)
...
### 5.1 GRUB 如何加载内核到 head_64.S 入口点
...
### 5.5 BIOS IVT 与 Kernel IDT 的软件中断服务程序对比
...
### 3.3 SeaBIOS 如何加载引导扇区

#### 3.3.1 INT 19h 引导加载服务
...
## 4. boot.asm 与 GRUB boot.S 的相似之处
